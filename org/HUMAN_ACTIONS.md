...
| H8 | **Merge or reject the README front-door PR** | Prose on a public surface. `RELEASE_PLAN` sanctions the pass; the taste is yours, and there is no cost to it waiting | Nothing | Left as an open PR by design during `ACT-039`, never merged by an agent |
