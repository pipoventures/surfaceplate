...
| 2.6 | F-O Actions claim | — | The maintainer verifies whether Actions is disabled at organisation level and one document wins; recorded in the phase's completion record | The maintainer's statement, dated |
