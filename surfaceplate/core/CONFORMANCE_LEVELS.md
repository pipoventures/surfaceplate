...
the twelve controls, as stated above — so the list above is no longer partial.
...
58 codes. Generated from the checker's own source by `tests/check_code_registers.py --write`;
...
| `SP061` | '<file>' repeats a key, so part of it would be silently discarded |

<!-- END GENERATED: finding codes -->

## What each level requires, by topic

<!-- BEGIN GENERATED: levels by topic (tests/check_code_registers.py --write) -->
...
|---|---|---|---|---|
| 1. Authority and the documentary record | — | — | `documentation_authority` | `documentation_authority` |
| 3. Work definition | `agent_work_packets` | — | — | — |
| 6. Evidence and completion | `actual_diff_review` | — | — | `assurance_findings` |
| 7. Testing | — | — | `contract_tests`, `deterministic_tests` | `contract_tests`, `deterministic_tests` |
| 8. Confidentiality and data boundaries | `secret_hygiene` | — | — | — |
| 9. Dependencies and supply chain | — | `dependency_lock` | `dependency_lock` | `dependency_lock` |
| 10. Provenance and lineage | — | — | — | `method_registry`, `overrides`, `provenance`, `run_lineage` |

<!-- END GENERATED: levels by topic -->
